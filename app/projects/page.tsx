  ...
  return (
    <>
      <section className="page-hero projects-hero">
        ...
        <div className="page-hero-bottom"><p>Recruitment, service, and engineering websites built around practical requirements and clear user experiences.</p><span>04 LIVE PROJECTS</span></div>
      </section>
